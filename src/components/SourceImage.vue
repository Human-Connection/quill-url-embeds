<template>
  <span class="ql-embed-source-image">
    <img :src="image"
        @error="hasError = true"
        v-if="image && !hasError" />
    <span v-else>
